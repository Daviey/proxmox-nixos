[
  {
    ...
    rev = "5f625aacbd6f81d97a1c6f5476fb38769d069f26";

    sha256 = "1gjalk4k9y9hmlgqyh1p54n2pfz2fi67qylx8gsg6xnhbd5dfppg";
    crates = [
      {
        name = "pathpatterns";
        path = ".";
  ...
  }
  {
    ...
    rev = "57b0477657aa32b3b705f8a6399dbe1396da5db4";

    sha256 = "0ypvd0rpzw49sp46m7crsmg5pmxc8pcn7sjjz9h6nlq44as1zr8l";
    crates = [
      {
        name = "pbs-api-types";
        path = "pbs-api-types";
  ...
  }
  {
    ...
    rev = "717da0f5cb32d633c9a76aee1279124f2b40542b";
    patches = [ ../perlmod/remove_safe_putenv.patch ];
    sha256 = "1v935y0anvwif4srnlj2dhz5ckbixzywfmcjb4kbljwmnda5p7im";
    crates = [
      {
        name = "perlmod";
        path = "perlmod";
  ...
  }
  {
    ...
    url = "https://git.proxmox.com/git/proxmox.git";
    rev = "ca92328569c56e499bc6f704ca6935fba10d572f";

    sha256 = "0p1yw119fj546ib4pc1sx1rk3lnnc9nwlnsq0vnnm38lapg21swm";
    crates = [
      {
  ...
  }
  {
    ...
    url = "https://git.proxmox.com/git/proxmox.git";
    rev = "94b9f8db60dcd12c5a154c461c256d62d047df80";

    sha256 = "1p0zy9xlzadaax5fkxl15lq9gq16si21yyfpkby8ji1lhayc0x00";
    crates = [
      {
        name = "proxmox-notify";
        path = "proxmox-notify";
  ...
  }
  {
    ...
    url = "https://git.proxmox.com/git/proxmox-resource-scheduling.git";
  ...
  }
  {
    ...
    url = "https://git.proxmox.com/git/proxmox-ve-rs.git";
  ...
  }
  {
    ...
    rev = "410f326a08ef6c08141af5c7431beb2e16f0c666";

    sha256 = "1m9sal20y4c3hcrfmq2r2df31kpa4vb0fk1gida7agyvcjnysasi";
    crates = [
      {
        name = "pxar";
        path = ".";
